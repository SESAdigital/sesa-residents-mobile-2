...
type Props = AppScreenProps<'ADD_DEPENDENT_SUCCESS_SCREEN'>;

const AddDependentSuccessScreen = ({ route }: Props): React.JSX.Element => {
...
export default AddDependentSuccessScreen;
