...
import { getPropertyDependentsEvents } from '@src/api/household.api';
...
const DependentEventsSceen = (): React.JSX.Element => {
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } =
    useInfiniteQuery({
      ...
      queryFn: async ({ pageParam }) => {
        const response = await getPropertyDependentsEvents({
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => <GenericEventRow value={item} />}
...
export default DependentEventsSceen;
