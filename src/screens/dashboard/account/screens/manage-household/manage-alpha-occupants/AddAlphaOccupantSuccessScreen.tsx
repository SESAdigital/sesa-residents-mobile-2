...
type Props = AppScreenProps<'ADD_ALPHA_OCCUPANT_SUCCESS_SCREEN'>;

const AddAlphaOccupantSuccessScreen = ({ route }: Props): React.JSX.Element => {
  ...
  return (
    <AppScreen showDownInset>
      ...
      <View style={styles.footer}>
        <SubmitButton
          title="Add another alpha occupant"
...
export default AddAlphaOccupantSuccessScreen;
