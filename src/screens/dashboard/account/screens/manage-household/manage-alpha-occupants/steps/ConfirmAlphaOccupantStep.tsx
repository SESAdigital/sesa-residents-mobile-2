...
const ConfirmAlphaOccupantStep = (props: Props): React.JSX.Element => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <AppText style={styles.headerTitle}>Confirm alpha occupant</AppText>
...
export default ConfirmAlphaOccupantStep;
