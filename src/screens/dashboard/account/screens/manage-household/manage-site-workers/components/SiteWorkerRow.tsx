...
import { GetHouseholdSiteWorkersResData } from '@src/api/household.api';
...
interface Props {
  onPress?: () => void;
  data: GetHouseholdSiteWorkersResData;
...
export const SiteWorkerRowLoader = (): React.JSX.Element => {
  return (
